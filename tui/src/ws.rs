...
pub enum GameNotification {
    Countdown { game_id: GameId, remaining: u32 },
    GameStarted { game_id: GameId, starting_price: i32, starting_balance: i32, players: Vec<PlayerId> },
    PriceChanged { game_id: GameId, price: i32 },
    BidPlaced { game_id: GameId, player_id: PlayerId, bid_value: i32 },
    AskPlaced { game_id: GameId, player_id: PlayerId, ask_value: i32 },
    BidFilled { game_id: GameId, player_id: PlayerId, bid_value: i32 },
    AskFilled { game_id: GameId, player_id: PlayerId, ask_value: i32 },
    GameEnded { game_id: GameId },
}
